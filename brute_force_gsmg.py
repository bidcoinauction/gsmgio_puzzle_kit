...
from bip_utils import (
    ...
    Bip44Changes, Bip39WordsNum, Bip39MnemonicGenerator, Bip39EntropyGenerator
)
...
def run_full_search():
    ...
    print("[*] Launching brute-force permutation scan...")
    with Pool(cpu_count()) as pool:
        for result in pool.imap_unordered(worker, itertools.permutations(SCRAMBLED_WORDS)):
            if result:
